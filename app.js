...
app.use((req, res, next) => {
  ...
  res.setHeader(
    ...
    "X-Requested-With, Content-Type, auth-token, Referer, User-Agent, Accept"
  );
...
const courseBundleRoutes = require("./routes/courseBundleRoutes");
app.use("/api/coursebundle", courseBundleRoutes);
